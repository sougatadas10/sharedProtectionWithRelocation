...
public class SharedProtectionwithRelocationObsolete {
	...
	private void calcTotalWavelengths() {
		...
		if (numberOfRequests > 1){
			for (i1=0;i1<primaryPaths.size()-1;++i1){
		...
		if (numberOfRequests > 1){
			for (i1=0;i1<backupPaths.size()-1;++i1){
	...
	public static void main(String[] args) throws InterruptedException,IOException{
		...
		final SharedProtectionwithRelocationObsolete SPR1=new SharedProtectionwithRelocationObsolete();
